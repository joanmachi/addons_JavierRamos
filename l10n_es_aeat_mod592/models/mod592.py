...
class L10nEsAeatmod592Report(models.Model):
    ...
    def get_acquirer_moves_domain(self):
        _logger.info('-------------------')
        _logger.info('def get_acquirer_moves_domain')
        _logger.info('-------------------')
        """
    ...
    def get_manufacturer_moves_domain(self):
        _logger.info('-------------------')
        _logger.info('def get_manufacturer_moves_domain')
        _logger.info('-------------------')
        ...
        domain = expression.AND([
            domain_base, expression.OR([
                domain_concept_1,  domain_concept_4])])
        _logger.info('-------------------')
        _logger.info('domain')
        _logger.info(domain)
        _logger.info('-------------------')
    ...
    def calculate(self):
        ...
        for item in self:
            ...
            if item.company_plastic_acquirer:
                acquirer_lines = []
                _logger.info('*****************')
                _logger.info('_get_acquirer_moves')
                _logger.info(item._get_acquirer_moves())
                _logger.info('*****************')
            ...
            if item.company_plastic_manufacturer:
                manufacturer_lines = []
                _logger.info('*****************')
                _logger.info('_get_manufacturer_moves')
                _logger.info(item._get_manufacturer_moves())
                _logger.info('*****************')
                ...
                _logger.info('*****************')
                _logger.info('manufacturer_lines')
                _logger.info(manufacturer_lines)
                _logger.info('*****************')
